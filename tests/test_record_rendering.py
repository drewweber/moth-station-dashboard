...
class RecordRenderingTests(unittest.TestCase):
    ...
    def test_history_live_mode_control_and_immediate_live_check_are_rendered(self) -> None:
        ...
        self.assertIn('id="live-update"', page)
        ...
        self.assertIn('els.update.addEventListener("click"', LIVE_JS)
        self.assertIn("state.isChecking", LIVE_JS)
    ...
    def test_forecast_validation_separates_historical_and_published_evidence(self) -> None:
        ...
        self.assertIn("All three methods use the same target predictions", html)
        self.assertIn("Seasonal-only", html)
        self.assertIn("Host-only", html)
        self.assertIn("Seasonal + host", html)
        self.assertIn("Legacy published target lists", html)
        self.assertIn("12%", html)
        self.assertIn("40</dd><small>across all stations", html)
        self.assertIn("12</dd><small>at a station in the following two weeks", html)
